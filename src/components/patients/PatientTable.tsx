...
const initialPatients: Patient[] = [
  { id: '1', mrn: 'MRN001', firstName: 'Alice', lastName: 'Smith', dob: new Date('1990-05-15'), gender: 'Female', phone: '555-0101', email: 'alice.smith@example.com', address: '123 Oak St, Anytown' },
  { id: '2', mrn: 'MRN002', firstName: 'Bob', lastName: 'Johnson', dob: new Date('1985-08-22'), gender: 'Male', phone: '555-0102', email: 'bob.johnson@example.com', address: '456 Pine St, Anytown' },
  { id: '3', mrn: 'MRN003', firstName: 'Carol', lastName: 'Williams', dob: new Date('2000-01-30'), gender: 'Female', phone: '555-0103', email: 'carol.williams@example.com', address: '789 Maple St, Anytown' },
  { id: '4', mrn: 'MRN004', firstName: 'David', lastName: 'Brown', dob: new Date('1978-11-03'), gender: 'Male', phone: '555-0104', email: 'david.brown@example.com', address: '101 Elm St, Anytown' },
  { id: '5', mrn: 'MRN005', firstName: 'Eve', lastName: 'Davis', dob: new Date('1995-07-19'), gender: 'Female', phone: '555-0105', email: 'eve.davis@example.com', address: '202 Birch St, Anytown' },
];
        ...
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="font-headline text-primary">
              {selectedPatient ? 'Edit Patient Details' : 'Add New Patient'}
            </DialogTitle>
            <DialogDescription>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          {selectedPatient && (
            <div className="space-y-3 py-4">
              ...
              <p><strong>Date of Birth:</strong> {format(selectedPatient.dob, 'MMMM dd, yyyy')}</p>
